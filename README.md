...
- [ ] Mark Add caching and multi-OS/Python/PyTorch testing to your continuous integration (M17)
...
- [ ] Albert Add a continuous workflow that triggers when data changes (M19)
- [ ] Cathialina Add a continuous workflow that triggers when changes to the model registry are made (M19)
- [ ] Mark Create a data storage in GCP Bucket for your data and link this with your data version control setup (M21)
- [ ] Mark Create a trigger workflow for automatically building your Docker images (M21)
- [ ] Albert Get your model training in GCP using either the Engine or Vertex AI (M21)
...
- [ ] Albert Write API tests for your application and set up continuous integration for these (M24)
- [ ] Mark Load test your application (M24)
- [ ] Albert Create a more specialized ML-deployment API using either ONNX or BentoML, or both (M25)
